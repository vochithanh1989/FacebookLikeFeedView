 ...
 */
public class SlidingTabAlbumLayout extends HorizontalScrollView {
    /**
    ...
    public SlidingTabAlbumStrip getTabStrip() {
        return mTabStrip;
    }
    private final SlidingTabAlbumStrip mTabStrip;


    public SlidingTabAlbumLayout(Context context) {
        this(context, null);
    }

    public SlidingTabAlbumLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabAlbumLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new SlidingTabAlbumStrip(context);
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link info.androidhive.listviewfeed.SlidingTab.SlidingTabAlbumLayout} you are
    ...
    private void populateTabStrip() {
        final ViewPagerAlbumAdapter adapter =(ViewPagerAlbumAdapter) mViewPager.getAdapter();
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextSize(13);//14
        }
    }
